...
export default function UserLogin() {
  ...
  const title = mode === "new" ? "New Sign in" : mode === "returning" ? "Sign in" : "Sign in";
      ...
      <div className="relative z-10 flex items-stretch mx-4">
        ...
        >
          <div className="flex flex-col items-start gap-3">
            <svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-14 h-14 text-white">
              <path
